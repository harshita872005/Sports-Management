...
<head>
  ...
  <style>
    ...
    .facebook-icon:hover { color: #1877F2; }
...
<body class="bg-gray-50">
  ...
  <section class="py-16 bg-gray-50">
    <div class="max-w-6xl mx-auto px-4">
      <h2 class="text-3xl font-bold text-center mb-12 heading-gradient">Popular Sports Categories</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 sport-card">
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold mb-2 text-blue-600">Football</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 sport-card">
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold mb-2 text-blue-600">Basketball</h3>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 sport-card">
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold mb-2 text-blue-600">Tennis</h3>
  ...
  <section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-4">
      <h2 class="text-3xl font-bold text-center mb-12 heading-gradient">What Our Members Say</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-gray-50 p-8 rounded-xl shadow-lg review-card">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a href="#" class="text-2xl transition-colors facebook-icon"><i class="fab fa-facebook"></i></a>
            <a href="#" class="text-2xl transition-colors twitter-icon"><i class="fab fa-twitter"></i></a>
            <a href="#" class="text-2xl transition-colors instagram-icon"><i class="fab fa-instagram"></i></a>
            <a href="#" class="text-2xl transition-colors youtube-icon"><i class="fab fa-youtube"></i></a>
          </div>
        </div>
      </div>
