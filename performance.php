...
if ($role == 'player') {
    ...
    $players = [];
    $groupedPlayers = []; // Initialize the groupedPlayers array
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_performance']) && isset($_POST['player_id'])) {
        ...
        <form method="POST" action="">
          <?php if ($role == 'admin'): ?>
            ...
            <?php else: ?>
              <div class="text-center py-8 bg-yellow-50 rounded-lg">
                <i class="fas fa-exclamation-circle text-6xl text-yellow-500 mb-4"></i>
                <p class="text-xl text-gray-700">No teams with approved players found.</p>
              </div>
            <?php endif; ?>
          <?php else: ?>
            ...
            <?php else: ?>
              <div class="text-center py-8 bg-yellow-50 rounded-lg">
                <i class="fas fa-exclamation-circle text-6xl text-yellow-500 mb-4"></i>
                <p class="text-xl text-gray-700">No approved players found in your team.</p>
              </div>
            <?php endif; ?>
          <?php endif; ?>

          <?php if (($role == 'admin' && !empty($groupedPlayers)) || ($role == 'team' && !empty($players))): ?>
